...
<div id="change-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Change Brand</h4>
        <button type="button" class="close" data-dismiss="modal">
          <span aria-hidden="true">×</span>
          <span class="sr-only">close</span>
        </button>
...
function deleteF(id) {
  bootbox.confirm("Do you want to delete brand", function (result) {
    if (result) {

      $.ajax({
        type: 'get',
        url: "inc/post/brand/deletebrand.php",
        data: "id="+id,
