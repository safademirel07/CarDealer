          ...
          <div class="row">
            <div class="page-header">
              <div class="d-flex align-items-center">
                <h2 class="page-header-title">Comment of <?php echo getCarDetail($carID,"title")?></h2>
              </div>
            </div>
          </div>
          <!-- End Page Header -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="addCommentForm">
              ...
              <div class="col-lg-9">
                <input type="text" id="message" name="message" placeholder="" class="form-control">
              </div>
              <br>
  ...
  function deleteF(id,carid) {
    bootbox.confirm("Do you want to delete comment", function (result) {
      if (result) {
        ...
        $.ajax({
          type: 'get',
          url: "inc/post/comment/deletecomment.php",
