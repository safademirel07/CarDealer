            ...
            <div class="col-xl-12">
              ...
              <div class="widget has-shadow">
                <div class="widget-body">
                  <button class="add-modal" type="button" class="btn btn-primary" data-toggle="modal"
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover mb-0">
                      ...
                      <tbody>
                        ...
                        echo '
                        <tr>
                        <td><span class="text-primary">' . $model->id . '</span></td>
                        <td>' . getBrandName($model->brand_id). '</td>
                        <td>' . $model->name . '</td>
                        <td> ' . getTypeName($model->type_id). '</td>
                        <td class="td-actions">
                        <button class="change-modal" data-toggle="modal" data-target="#change-modal"  data-id=' . $model->id . ' data-brandid=' . $model->brand_id . ' data-typeid=' . $model->type_id . ' data-name="' . $model->name . '" type="button"><i class="la la-edit edit"></i></button>
                        <button onclick="deleteF(' . $model->id . ')"><i class="la la-close delete"></i></button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addModelForm">
            ...
            <label class="col-lg-3 form-control-label">Brand</label>
            <div class="col-lg-9">
...
$(document).ready(function () {
  ...
  $(document).on("click", ".change-modal", function () {
    ...
    $(".col-lg-9 #brand").val(brandid);
    $(".col-lg-9 #type").val(typeid);
  });
...
function deleteF(id) {
  bootbox.confirm("Do you want to delete model", function (result) {
    if (result) {

      $.ajax({
        type: 'get',
        url: "inc/post/model/deletemodel.php",
        data: "id="+id,
