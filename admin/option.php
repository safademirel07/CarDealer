                    ...
                    <table class="table table-hover mb-0">
                      ...
                      <tbody>
                        ...
                        foreach ($records as $record)
                        {
                          ...
                          $part = array("Security", "Internal Hardware", "External Hardware","Multimedia","Replaced","Painted");

                          echo '
                          <tr>
                          <td><span class="text-primary">' . $record->id . '</span></td>
                          <td>' . $part[$record->type-1] . '</td>
                          <td>' . $record->name . '</td>
                          <td class="td-actions">
                          <button class="change-modal" data-toggle="modal" data-target="#change-modal" data-id=' . $record->id . ' data-name=' . $record->name . ' data-type=' . $record->type . ' type="button"><i class="la la-edit edit"></i></button>
