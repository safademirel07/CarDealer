          ...
          <div class="row">
            <div class="page-header">
              <div class="d-flex align-items-center">
                <h2 class="page-header-title">Gear</h2>
              </div>
            </div>
          </div>
          <!-- End Page Header -->
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover mb-0">
                      ...
                      <tbody>
                        ...
                        echo '
                        <tr>
                        <td><span class="text-primary">' . $type->id . '</span></td>
                        <td>' . $type->name . '</td>
                        <td class="td-actions">
                        <button class="change-modal" data-toggle="modal" data-target="#change-modal" data-id=' . $type->id . ' data-name="' . $type->name . '" type="button"><i class="la la-edit edit"></i></button>
                        <button onclick="deleteF(' . $type->id . ')"><i class="la la-close delete"></i></button>
...
<div id="change-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Change Gear</h4>
        <button type="button" class="close" data-dismiss="modal">
          <span aria-hidden="true">×</span>
          <span class="sr-only">close</span>
        </button>
...
function deleteF(id) {
  bootbox.confirm("Do you want to delete fuel", function (result) {
    if (result) {

      $.ajax({
        type: 'get',
        url: "inc/post/fuel/deletefuel.php",
        data: "id="+id,
